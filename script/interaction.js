$(document).ready(function(){
	...
	var hgrid = 2000;
	var lastClass;
	/*var projectsList = ["spykar", "indiabulls", "sky", "palava", "welspun", "spun", "aegon", "golf", "greens", "prius"];*/
	...
	function project(projectname) {
		setTimeout(function(){ 
			...
			$("#projet").load("projects/"+projectname+".html", function(){ console.log("ok"); openprojet() }); 
		}, 1000);
	}
		...
		if (isOpening == false) {
			...
			for (var i = 0; i < projectsList.length; i++) { 
			    if (lastClass == projectsList[i]) {
			    	...
			    	if (i == 0) { 
			    		setTimeout(function(){  
				    		$("body").attr("class", "projet nav "+projectsList[9]);
				    		$(".previous").attr("class", "previous transition "+projectsList[9]);
				    		$(".next").attr("class", "next "+projectsList[9]);
				    		$("#projet").load("projects/"+projectsList[9]+".html", function(){ console.log("ok"); openprojet() }); 
			    		}, 2000);
			    	} 
			    	else { 
			    		numprojet = i-1; 
			    		setTimeout(function(){  
			    			...
			    			$("#projet").load("projects/"+projectsList[numprojet]+".html", function(){ console.log("ok"); openprojet() }); 
			    		}, 2000);
			    	}	
			    }
			}
			    ...
			    if (lastClass == projectsList[i]) {
			    	...
			    	if (i == 9) { 
			    		setTimeout(function(){  
				    		...
				    		$("#projet").load("projects/"+projectsList[0]+".html", function(){ console.log("ok"); openprojet() }); 
			    		}, 2000);
			    	} 
			    	else { 
			    		numprojet = i+1; 
	...
	$("#logosmall, .menuworks, .menublog").click(function(){
		closenav(); // mobile
...
$(window).load(
    function() {
    	if ($(window).width() < 960 ) { hgrid = $("#grid .content").height() + 400; }
        	...
        	if ($(window).width() > 1786) { hgrid = (409*8)*(1786/1440) - 600; }
        	else { hgrid = (409*8)*($(window).width()/1440) - 500; }
        }
        $("#grid").css("height", hgrid);
